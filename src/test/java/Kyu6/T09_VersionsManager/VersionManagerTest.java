...
class VersionManagerTest {
    ...
    @Test
    @Order(1)
    @DisplayName("VersionManager initialization without initial version")
    ...
    @Order(8)
    @DisplayName("Invalid initial version")
