...
public class Tests {
    ...
    public void testBasic2() {
        assertEquals(9, NewKata.squareSum(new int[]{1, 2, 2}));
        assertEquals(5, NewKata.squareSum(new int[]{1, 2}));
        assertEquals(50, NewKata.squareSum(new int[]{5, -3, 4}));
        assertEquals(0, NewKata.squareSum(new int[]{}));
    }
}
